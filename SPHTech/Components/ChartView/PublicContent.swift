...
extension UIView{
    ...
    public func addBlurEffect(effStyle:UIBlurEffect.Style){
    ...
    public func castShadow(color:UIColor,gap:CGFloat,shadowImage:UIImage?){
        ...
        superV.sendSubviewToBack(shawView)
        ...
        superV.addConstraints([
            NSLayoutConstraint.init(item: shawView, attribute: NSLayoutConstraint.Attribute.width, relatedBy: NSLayoutConstraint.Relation.equal, toItem: self, attribute: NSLayoutConstraint.Attribute.width, multiplier: 0.9, constant: 0),
            NSLayoutConstraint.init(item: shawView, attribute: NSLayoutConstraint.Attribute.height, relatedBy: NSLayoutConstraint.Relation.equal, toItem: shawView, attribute: NSLayoutConstraint.Attribute.width, multiplier: 0.15, constant: 0),
            NSLayoutConstraint.init(item: shawView, attribute: NSLayoutConstraint.Attribute.centerX, relatedBy: NSLayoutConstraint.Relation.equal, toItem: self, attribute: NSLayoutConstraint.Attribute.centerX, multiplier: 1, constant: 0),
            NSLayoutConstraint.init(item: shawView, attribute: NSLayoutConstraint.Attribute.top, relatedBy: NSLayoutConstraint.Relation.equal, toItem: self, attribute: NSLayoutConstraint.Attribute.bottom, multiplier: 1, constant:gap)])
    }
    ...
    public func creatHollowInMap(hollowRect:CGRect,BGColor:UIColor,handle:@escaping (UIView)->(Void)){
        ...
        showShareLayer.fillRule = CAShapeLayerFillRule.evenOdd;//中间镂空的关键点 填充规则 这里采用的是奇偶规则
...
extension UIColor{
    ...
    convenience init(RGBA: String) {
        ...
        if RGBA.hasPrefix("#") {
            let hex:String  = RGBA.subString(start: 2, end: RGBA.count)
...
extension UIImage{
    ...
    func cropImage(rect : CGRect) -> UIImage {
        ...
        return UIImage.init(cgImage: newCgImage, scale: scale, orientation: UIImage.Orientation.up)
    }
...
extension UIButton{
    ...
    func setButtonImageSize(type:FBButtonType, space:CGFloat){
        ...
        if(type == FBButtonType.ImageLeft){
            ...
            self.imageEdgeInsets = UIEdgeInsets(top: 0, left: 0, bottom: -labelHeight-space/2.0, right: -labelWidth);
            self.titleEdgeInsets = UIEdgeInsets(top: -imageHeight-space/2.0, left: -imageWith, bottom: 0, right: 0);
            ...
            self.titleEdgeInsets = UIEdgeInsets(top: 0, left: -imageWith, bottom: -imageHeight-space/2.0, right: 0);
...
extension String {
    ...
    public func subString(start:NSInteger,end:NSInteger) -> String{
        ...
        if(start<=0||end>self.count||start>end){ //如果范围不对   就会返回一个空的字符串 表示没有获取到字符
            ...
            let strArr: [String] = self.splitStringToArr()
    ...
    public func splitStringToArr() -> [String]{
        ...
        while index1 != index2{
            ...
            desStr = String(self[Range.init(uncheckedBounds: (lower: index1, upper: index2))])
            if(desStr.count != 0){
...
class ProgressView:UIView{
    ...
    convenience init(atView:UIView,frame:CGRect){
        ...
        CASharp.lineCap = CAShapeLayerLineCap(rawValue: "round")
        CASharp.lineJoin = CAShapeLayerLineJoin(rawValue: "round")  //包角为圆形
